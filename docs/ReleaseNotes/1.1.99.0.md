...
# Version 1.1.99.0-prerelease - `<Split'n'Polish: AeroRadial>` edition

* 23 Jul 2022
* Released for Kerbal Space Program [KSP 1.12.x]

<div style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center"><h4>
<b>DO A CLEAN INSTALL:</br> DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/AeroRadial/files">CurseForge</a></p></div>
...
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/192742-*/ "AeroRadial forum thread"
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/AeroRadial%20(ABBV)%20-v0.9.9.9--prerelease-BADA55.svg?style=plastic&labelColor=darkgreen/ "0.9.9.9-prerelease"
